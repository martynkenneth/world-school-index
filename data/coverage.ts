...
export const countryCoverage: CountryCoverage[] = [
  ...
  { name: "Singapore", slug: "singapore", code: "SG", region: "Southeast Asia", stage: "published", stageLabel: "Published · initial collection", nextStep: "Expand the candidate inventory and verify fees, addresses, language and open-day fields.", wave: 1 },
