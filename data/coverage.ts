...
export const countryCoverage: CountryCoverage[] = [
  ...
  { name: "Thailand", slug: "thailand", code: "TH", region: "Southeast Asia", stage: "research", stageLabel: "Research next", nextStep: "Build Bangkok, Chiang Mai, Phuket and regional candidate lists.", wave: 1 },
